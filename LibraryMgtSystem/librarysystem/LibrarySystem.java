...
import LibraryMgtSystem.business.ControllerInterface;
import LibraryMgtSystem.business.SystemController;
...
public class LibrarySystem extends JFrame implements LibWindow {
	...
	JMenuBar menuBar;
    JMenu options;
    JMenuItem login, allBookIds, allMemberIds, addBooks, addMembers;
    String pathToImage;
    ...
    private void addMenuItems() {
       options = new JMenu("Options");  
        ...
        addMembers.addActionListener(new AllMemberIdsListener());
